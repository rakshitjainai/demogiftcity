  ...
  return (
    <div className="py-16 px-6 max-w-5xl mx-auto animate-fade-in-up">
      <div className="text-center mb-16">
        ...
        <h1 className="text-4xl md:text-5xl font-display text-forest-deep mb-6">Our Mission</h1>
      ...
      <div className="bg-white border border-line rounded-3xl p-8 md:p-12 card-shadow">
        <div className="flex flex-col md:flex-row gap-10 items-center md:items-start">
          <div className="w-40 h-40 rounded-full bg-mint-deep flex-shrink-0 border-4 border-white shadow-lg overflow-hidden flex items-center justify-center">
             <span className="text-4xl font-display text-forest">PK</span>
          </div>
          <div>
            <span className="eyebrow block mb-2">§ Founder & Author</span>
            <h2 className="text-3xl font-display text-forest-deep mb-2">CS Prashant Kumar</h2>
            <p className="text-leaf font-medium mb-6">Company Secretary & Compliance Expert</p>
            ...
            <div className="flex gap-4">
              <button className="cursor-target p-3 rounded-full bg-paper border border-line hover:bg-mint text-forest transition-colors">
